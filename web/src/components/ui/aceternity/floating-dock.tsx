                ...
                {entry.options.map((option) => {
                    ...
                    return (
                        <span key={option.id} className="relative inline-flex shrink-0">
                            ...
                            >
                                <span className="grid shrink-0 place-items-center" style={{ width: option.iconSize ?? (labeled ? 16 : defaultIconSize), height: option.iconSize ?? (labeled ? 16 : defaultIconSize) }}>
                                    {option.icon}
                                </span>
